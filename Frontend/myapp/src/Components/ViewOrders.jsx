...
const ViewOrders = () => {
    ...
    const columns = [
      ...
      },
      {
          ...
          render: (text) => (
            <>
          <span style={{color:'blue',cursor:'pointer',fontSize:'20px',marginRight:'15px'}} onClick={()=>navigate('/updateOrder',{state:text})}>Update</span>
  ...
  return (
    <Modal  width={900} title="Your Orders" open={isModalOpen} onOk={handleOk}  onCancel={handleCancel} footer={null}>
