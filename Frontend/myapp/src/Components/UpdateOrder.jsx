  ...
  return (
    ...
    footer={null}>
      ...
      onValuesChange={onFormLayoutChange}>
        ...
        <Input placeholder="Order Id" style={{width:'220px'}} defaultValue={state._id} disabled />
      </Form.Item>
      <Form.Item label="Product Name">
        <Input placeholder="Product Name" style={{width:'220px'}} defaultValue={state.order.name} disabled />
      </Form.Item>
      <Form.Item label="Product Description">
        <TextArea placeholder="Product Description" defaultValue={state.order.description} disabled/>
      </Form.Item>
      <Form.Item label="Product Category">
        <Select placeholder="Category"  style={{width:"180px",padding:"5px"}} defaultValue={state.order.category} disabled>
      ...
      <Form.Item label="Order Price">
        <Input placeholder="Price" style={{width:'220px'}}  defaultValue={TotalPrice} disabled/>
      </Form.Item>
      <Form.Item label="Order Quantity">
        <Input placeholder="Price" style={{width:'220px'}}  defaultValue={state.Quantity} disabled/>
      </Form.Item>
      <Form.Item >
        <Button type="primary" style={{textAlign:'center',margin:'auto',display:'table'}} onClick={()=>handleUpdate(state._id)}>Update Order Status</Button>
      </Form.Item>
    </Form>
    </Modal>
  );
